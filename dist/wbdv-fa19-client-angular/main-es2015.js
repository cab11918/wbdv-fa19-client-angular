...
let CourseGridComponent = class CourseGridComponent {
...
CourseGridComponent.ctorParameters = () => [
...
let CourseViewerComponent = class CourseViewerComponent {
    //
    // courses = [];
    // modules = [];
    // lessons = [];
...
CourseViewerComponent.ctorParameters = () => [
...
let LessonTabsComponent = class LessonTabsComponent {
    constructor(router, service) {
        this.router = router;
        this.service = service;
        this.courseId = '';
...
LessonTabsComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let CourseServiceClient = class CourseServiceClient {
    constructor() {
        this.findAllCourses = () => fetch('https://tranquil-hamlet-37825.herokuapp.com/api/courses')
            .then(response => response.json());
...
let LessonServiceClient = class LessonServiceClient {
    constructor() {
        this.findAllLessonsForModule = moduleId => fetch(`https://tranquil-hamlet-37825.herokuapp.com/api/modules/${moduleId}/lessons`)
            .then(response => response.json());
        this.findLessonsById = lessonId => fetch(`https://tranquil-hamlet-37825.herokuapp.com/api/lessons/${lessonId}`)
            .then(response => response.json());
    }
};
...
let ModuleServiceClient = class ModuleServiceClient {
    constructor() {
        this.findAllModulesForCourse = courseId => fetch(`https://tranquil-hamlet-37825.herokuapp.com/api/courses/${courseId}/modules`)
            .then(response => response.json());
    }
};
...
let TopicServiceClient = class TopicServiceClient {
    constructor() {
        this.findTopicsForLesson = lessonId => fetch(`https://tranquil-hamlet-37825.herokuapp.com/api/lessons/${lessonId}/topics`)
            .then(response => response.json());
        this.findTopicById = topicId => fetch(`https://tranquil-hamlet-37825.herokuapp.com/api/topics/${topicId}`)
            .then(response => response.json());
    }
};
...
let WidgetServiceClient = class WidgetServiceClient {
    constructor() {
        this.findWidgetsForTopic = topicId => fetch(`https://tranquil-hamlet-37825.herokuapp.com/api/topics/${topicId}/widgets`)
            .then(response => response.json());
    }
};
...
let TopicPillsComponent = class TopicPillsComponent {
    constructor(router, service) {
        this.router = router;
        this.service = service;
        this.courseId = '';
...
TopicPillsComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let WidgetListComponent = class WidgetListComponent {
    constructor(router, service) {
        this.router = router;
        this.service = service;
        this.courseId = '';
...
WidgetListComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
